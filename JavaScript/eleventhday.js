...
//console.log("the series name is ",series.title,"which is streaming on",series.streaming,"in language",series.language,"which is a ",series.genre,"series and has a rating of",series.rating );
//temptlate literals
// console.log(`the series name is ${series.title} 
// which is streaming on ${series.streaming}
// in language ${series.language} 
// which is a ${series.genre} 
// series and has a rating of ${series.rating}`);
...
let movies=[
  ...
  console.log(res1.length);
   ...
   let res2=movies.filter((x)=>{
     return x.imdbRating>8.5
   })
   console.log(res2);
